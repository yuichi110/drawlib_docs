...
def draw_icon():
    ...
    icon_phosphor.airplane_in_flight(xy=(50, y), width=w)
...
def draw_line():
    ...
    text((x1, y), "Line")
    line((30, y - 4), (30, y + 4))
    line((40, y - 4), (40, y + 4), style=LineStyle(style="dashed", color=Colors.Red))
    line((50, y - 4), (50, y + 4), arrowhead="->")
...
def draw_shape():
    ...
    arrow((90, y - 4), (90, y + 4), tail_width=2, head_width=5, head_length=3, head_style="<|-|>")
